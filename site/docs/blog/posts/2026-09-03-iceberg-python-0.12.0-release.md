...
- **[Strict `NotEqualTo`/`NotIn` pruning](https://github.com/apache/iceberg-python/pull/3521)**: no longer prunes files with partial nulls or NaNs
- **[`NOT STARTS WITH` projection](https://github.com/apache/iceberg-python/pull/3528)**: corrected for truncated partitions, along with [residual evaluation](https://github.com/apache/iceberg-python/pull/3503) and the [string-based `starts_with`/`not_starts_with` methods](https://github.com/apache/iceberg-python/pull/3501)
- **[`ManifestEntry.snapshot_id` setter](https://github.com/apache/iceberg-python/pull/3257)**: was writing to the wrong index
- **[`DELETED` manifest entry `snapshot_id`](https://github.com/apache/iceberg-python/pull/3237)**: fixed in `OverwriteFiles`
- **[Manifest min sequence number](https://github.com/apache/iceberg-python/pull/3660)**: a value of 0 is now preserved rather than dropped
- **[Deletion vector blob framing](https://github.com/apache/iceberg-python/pull/3576)**: the spec-mandated framing is now stripped before deserializing, with a [Spark interop test](https://github.com/apache/iceberg-python/pull/3476) covering the read path
- **[`deepcopy` of expressions](https://github.com/apache/iceberg-python/pull/3295)**: fixed for `And`, `Or`, and `Not`
- **[Precision loss](https://github.com/apache/iceberg-python/pull/3405)**: fixed in large integral string conversions, with [Long bounds returned for decimal conversion](https://github.com/apache/iceberg-python/pull/3470), [bounds sentinels for long date literals](https://github.com/apache/iceberg-python/pull/3546), and an [overflow sentinel in `LongLiteral.to(FloatType)`](https://github.com/apache/iceberg-python/pull/3502)
- **[Nanosecond timestamp parsing](https://github.com/apache/iceberg-python/pull/3614)**: sub-microsecond digits are now padded correctly, and [non-UTC nanosecond timestamps](https://github.com/apache/iceberg-python/pull/3142) are handled
- **[Decimal encoding](https://github.com/apache/iceberg-python/pull/3746)**: minimal byte length is now used for negative powers of two
- **[Dictionary encoding](https://github.com/apache/iceberg-python/pull/3595)**: preserved in `to_arrow_batch_reader`
- **[`delete_data_file` on partitioned tables](https://github.com/apache/iceberg-python/pull/3780)** and **[residual `NotNaN` for null partition values](https://github.com/apache/iceberg-python/pull/3689)**
- **[Update builders after exceptions](https://github.com/apache/iceberg-python/pull/3354)**: no longer committed
- **[`write_default` under a name mapping](https://github.com/apache/iceberg-python/pull/3601)**: now preserved
- **[fsspec fixes](https://github.com/apache/iceberg-python/pull/3353)**: zero-byte files in `__len__`, [ADLS `account_name` extracted from the URI hostname](https://github.com/apache/iceberg-python/pull/3005), and [S3 virtual addressing parsed as a boolean](https://github.com/apache/iceberg-python/pull/3492)
- **[Hive SASL noise](https://github.com/apache/iceberg-python/pull/3357)**: `TSaslClientTransport` is no longer reused
- **[Validation](https://github.com/apache/iceberg-python/pull/3517)**: unsupported identity transform types, [empty `source-ids`](https://github.com/apache/iceberg-python/pull/3411), and [decimal precision outside the valid range](https://github.com/apache/iceberg-python/pull/3585) are now rejected
